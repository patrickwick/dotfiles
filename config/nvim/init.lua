...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'zig', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash' },
...
local on_attach_lsp = function(_, bufnr)
  ...
  map_normal_mode('<leader>rn', vim.lsp.buf.rename, '[R]e[n]ame')
  ...
  map_normal_mode('<C-k>', vim.lsp.buf.signature_help, 'Signature Documentation')

  -- Lesser used LSP functionality
  map_normal_mode('gD', vim.lsp.buf.declaration, '[G]oto [D]eclaration')
  map_normal_mode('<leader>wa', vim.lsp.buf.add_workspace_folder, '[W]orkspace [A]dd Folder')
  map_normal_mode('<leader>wr', vim.lsp.buf.remove_workspace_folder, '[W]orkspace [R]emove Folder')
  map_normal_mode('<leader>wl', function()
